...
set(WARN_TO_ERR_C_FLAGS "-Werror=format")
if (${BUILD_TYPE} STREQUAL "Debug")
    message("Debug build is active")
    set(C_FLAGS "${COMMON_C_FLAGS} ${WARN_TO_ERR_C_FLAGS} -O0 -g3 -gdwarf-4 -DDEBUG")
elseif(${BUILD_TYPE} STREQUAL "Release")
    message("Release build is active")
    set(C_FLAGS "${COMMON_C_FLAGS} ${WARN_TO_ERR_C_FLAGS} -O2 -DRELEASE")
else()
