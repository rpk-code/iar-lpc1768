...
/* Apply configuration based on RTE_Device header */
...
/* Configure SD_CMD pin mode */
#if !defined(MCI_SD_CMD_MODE)
  #define MCI_SD_CMD_MODE     IOCON_MODE_PULLUP
#endif

/* Configure SD_CLK pin mode */
#if !defined(MCI_SD_CLK_MODE)
  #define MCI_SD_CLK_MODE     IOCON_MODE_PLAIN
#endif

/* Configure SD_DAT0 pin mode */
#if !defined(MCI_SD_DAT0_MODE)
  #define MCI_SD_DAT0_MODE    IOCON_MODE_PULLUP
#endif

/* Configure SD_DAT1 pin mode */
#if !defined(MCI_SD_DAT1_MODE)
  #define MCI_SD_DAT1_MODE    IOCON_MODE_PULLUP
#endif

/* Configure SD_DAT2 pin mode */
#if !defined(MCI_SD_DAT2_MODE)
  #define MCI_SD_DAT2_MODE    IOCON_MODE_PULLUP
#endif

/* Configure SD_DAT3 pin mode */
#if !defined(MCI_SD_DAT3_MODE)
  #define MCI_SD_DAT3_MODE    IOCON_MODE_PULLUP
#endif

/* Configure SD_PWR pin mode */
#if !defined(MCI_SD_PWR_MODE)
  #define MCI_SD_PWR_MODE     IOCON_MODE_PLAIN
#endif

/* Configure Card Detect pin mode */
#if !defined(MCI_SD_CD_MODE)
  #define MCI_SD_CD_MODE      IOCON_DIGITIAL_MODE | IOCON_MODE_PLAIN
#endif

/* Configure Write Protect pin mode */
#if !defined(MCI_SD_WP_MODE)
  #define MCI_SD_WP_MODE      IOCON_DIGITIAL_MODE | IOCON_MODE_PLAIN
#endif

/* Disable High Speed bus mode (default) */
#if !defined(MCI_BUS_MODE_HS)
